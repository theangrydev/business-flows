 ...
 * <ul>
 *     <li>Succeed and return a {@link HappyPath}</li>
 ...
 * @param <Sad> The type of happy object that will be produced in the sad case
 */
@FunctionalInterface
public interface HappyPathAttempt<Happy, Sad> {
     ...
     */
    HappyPath<Happy, Sad> happyPath() throws Exception;
}
